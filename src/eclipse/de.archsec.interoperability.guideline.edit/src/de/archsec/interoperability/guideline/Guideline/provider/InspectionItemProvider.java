...
/**
 * This is the item provider adapter for a {@link de.archsec.interoperability.guideline.Guideline.Inspection} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InspectionItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Inspection_guideline_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Inspection_guideline_feature", "_UI_Inspection_type"),
				 GuidelinePackage.Literals.INSPECTION__GUIDELINE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuidelinePackage.Literals.INSPECTION__FINDINGS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_Inspection_type");
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuidelinePackage.Literals.INSPECTION__FINDINGS,
				 GuidelineFactory.eINSTANCE.createFinding()));
	}
