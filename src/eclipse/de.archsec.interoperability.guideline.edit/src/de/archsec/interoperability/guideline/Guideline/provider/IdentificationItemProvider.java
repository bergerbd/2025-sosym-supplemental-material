...
/**
 * This is the item provider adapter for a {@link de.archsec.interoperability.guideline.Guideline.Identification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IdentificationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Identification_target_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Identification_target_feature", "_UI_Identification_type"),
				 GuidelinePackage.Literals.IDENTIFICATION__TARGET,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuidelinePackage.Literals.IDENTIFICATION__ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 GuidelinePackage.Literals.IDENTIFICATION__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIsAutomatedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Identification_isAutomated_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Identification_isAutomated_feature", "_UI_Identification_type"),
				 GuidelinePackage.Literals.IDENTIFICATION__IS_AUTOMATED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GuidelinePackage.Literals.IDENTIFICATION__CHECKS);
		}
	...
	public String getText(Object object) {
		String label = ((Identification)object).getId();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GuidelinePackage.Literals.IDENTIFICATION__CHECKS,
				 GuidelineFactory.eINSTANCE.createCheck()));
	}
