...
/**
 * This is the item provider adapter for a {@link de.archsec.interoperability.guideline.Guideline.Check} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CheckItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Check_id_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Check_id_feature", "_UI_Check_type"),
				 GuidelinePackage.Literals.CHECK__ID,
				 true,
				 false,
				 false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Check_description_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Check_description_feature", "_UI_Check_type"),
				 GuidelinePackage.Literals.CHECK__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addIsAutomatedPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Check_isAutomated_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Check_isAutomated_feature", "_UI_Check_type"),
				 GuidelinePackage.Literals.CHECK__IS_AUTOMATED,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Check)object).getId();
